...
po.universe.config = {
	...
	box_url: '/local/Customizing/global/skin/po-v3.0/universe/content.php',
...
po.skyline.config = {
	// Skyline-JSON
	json_url: '/local/Customizing/global/skin/po-v3.0/skyline/skyline_json.js',
};
...
po.skyline.setup = function() {
	...
	po.skyline.wrapper = $("#po3-skyline a");
